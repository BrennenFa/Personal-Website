      ...
      <div className="max-w-6xl mx-auto px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="bg-gradient-to-br from-purple-600 to-purple-700 p-8 rounded-xl text-white shadow-xl shadow-purple-500/30">
              <h3 className="text-2xl font-semibold mb-4 flex items-center gap-2">
                <i className="fas fa-graduation-cap"></i> Education
              </h3>
              <h4 className="text-xl font-medium mb-2">North Carolina State University</h4>
              <p className="text-purple-100 mb-1">B.S. in Computer Science, Minor in Mathematics</p>
              <p className="text-purple-100 mb-4">GPA: 3.9 | December 2025</p>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 flex items-center gap-2">
                <i className="fas fa-code text-blue-500"></i> Software Engineering
              </h3>
              <div className="flex flex-wrap gap-3">
                {softwareSkills.map((skill, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-full text-sm text-gray-700 font-medium hover:bg-gradient-to-br hover:from-blue-500 hover:to-purple-600 hover:text-white hover:border-transparent hover:-translate-y-0.5 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 cursor-default"
                  >
                    {skill}
                  </span>
                ))}
            ...
            <div>
              <h3 className="text-xl font-semibold mb-4 text-gray-800 flex items-center gap-2">
                <i className="fas fa-brain text-purple-500"></i> Data Science & ML
              </h3>
              <div className="flex flex-wrap gap-3">

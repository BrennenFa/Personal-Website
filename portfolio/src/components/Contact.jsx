        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <a
              ...
              className="bg-white p-8 rounded-xl text-center no-underline hover:-translate-y-3 hover:shadow-2xl hover:border-red-600 transition-all duration-300 border-2 border-transparent shadow-md"
            >
              <i className="fas fa-envelope text-5xl mb-4 block bg-gradient-to-br from-red-600 to-red-800 bg-clip-text text-transparent"></i>
            ...
            <a
              ...
              className="bg-white p-8 rounded-xl text-center no-underline hover:-translate-y-3 hover:shadow-2xl hover:border-red-600 transition-all duration-300 border-2 border-transparent shadow-md"
            >
              <i className="fab fa-linkedin text-5xl mb-4 block bg-gradient-to-br from-red-600 to-red-800 bg-clip-text text-transparent"></i>
            ...
            <a
              ...
              className="bg-white p-8 rounded-xl text-center no-underline hover:-translate-y-3 hover:shadow-2xl hover:border-red-600 transition-all duration-300 border-2 border-transparent shadow-md"
            >
              <i className="fab fa-github text-5xl mb-4 block bg-gradient-to-br from-red-600 to-red-800 bg-clip-text text-transparent"></i>
            ...
            <a
              ...
              className="bg-white p-8 rounded-xl text-center no-underline hover:-translate-y-3 hover:shadow-2xl hover:border-red-600 transition-all duration-300 border-2 border-transparent shadow-md"
            >
              <i className="fas fa-phone text-5xl mb-4 block bg-gradient-to-br from-red-600 to-red-800 bg-clip-text text-transparent"></i>
